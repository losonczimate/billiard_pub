...
public class NotificationHelper {
    private static final String CHANNEL_ID = "billiard_pub_notification_channel";
    ...
    private void createChannel() {
        ...
        NotificationChannel channel = new NotificationChannel
                (CHANNEL_ID, "Billiard notification", NotificationManager.IMPORTANCE_HIGH);
